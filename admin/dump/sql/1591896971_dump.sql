...
INSERT INTO `joke_category` VALUES("1","1") ,("1","5") ,("5","4") ,("6","4") ,("6","5") ;
("1","1") ,("1","5") ,("5","4") ,("6","4") ,("6","5") ;

--
-- Структура таблицы: joke_ip
--
            DROP TABLE IF EXISTS `joke_ip`;
CREATE TABLE `joke_ip` (
  `joke_id` int NOT NULL,
  `ip_id` int NOT NULL,
  PRIMARY KEY (`joke_id`,`ip_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dump DB - table: joke_ip
--
            
INSERT INTO `joke_ip` VALUES;
;
...
INSERT INTO `jokes` VALUES("1","В Новый Год всё сбывается, даже то, что в другое время сбыть не удаётся.","2020-03-15","1","YES") ,("2","Хочешь петь - ПЕЙ!","2020-03-18","1","YES") ,("3","Если хочешь быть ЗДОРОВ, будь здоров!","2020-05-17","2","YES") ,("4","Шути - не шути, один хрен в конце концов, дошутишься.","2020-05-17","2","YES") ,("5","Зачем цыплёнок перешёл дорогу? Чтобы попасть на другую сторону.","2020-05-17","3","NO") ,("6","Адвокатом быть не легко. Легко бить адвоката.","2020-05-17","3","NO") ;
("1","В Новый Год всё сбывается, даже то, что в другое время сбыть не удаётся.","2020-03-15","1","YES") ,("2","Хочешь петь - ПЕЙ!","2020-03-18","1","YES") ,("3","Если хочешь быть ЗДОРОВ, будь здоров!","2020-05-17","2","YES") ,("4","Шути - не шути, один хрен в конце концов, дошутишься.","2020-05-17","2","YES") ,("5","Зачем цыплёнок перешёл дорогу? Чтобы попасть на другую сторону.","2020-05-17","3","NO") ,("6","Адвокатом быть не легко. Легко бить адвоката.","2020-05-17","3","NO") ;
...
("Администратор сайта","Добавление, удаление и редактирование катерий") ,("Администратор учётных записей","Добавление, удаление и редактирование авторов") ,("Редактор","Добавление, удаление и редактирование шуток") ;

--
-- Структура таблицы: userip
--
...
--
-- Dump DB - table: userip
--
            
INSERT INTO `userip` VALUES;
